...
Cf2py depend(NPTS) PRFUNC
      REAL(kind=4) DTT(0:NPTS-1),PRFUNC(0:NPTS-1)
      REAL(kind=4) TTHETA,SIG,CDSIG,CDGAM,SPH,DPRDT,DPRDG,DPRDD,DPRDLZ,DPRDS
      REAL(kind=4) GAM
...
Cf2py depend(NPTS) SLPART
      INTEGER(kind=4) NPTS,I
      REAL(kind=4) TTHETA,CDSIG,SIG,CDGAM,SPH,LPART
      REAL(kind=4) GAM
      REAL(kind=4) DTT(0:NPTS-1),DPRDT(0:NPTS-1),SIGPART(0:NPTS-1)
      REAL(kind=4) GAMPART(0:NPTS-1),SLPART(0:NPTS-1),PRFUNC(0:NPTS-1)
      SIG = CDSIG/10000.
      GAM = CDGAM/100.
      DO I=0,NPTS-1
...
Cf2py depend(NPTS) PRFUNC
      ...
      INTEGER(kind=4) NPTS
      REAL(kind=4) TTHETA,SIG,GAM,SPH
      REAL(kind=4) DTT(0:NPTS-1),PRFUNC(0:NPTS-1)
      DO I=0,NPTS-1
...
Cf2py depend(NPTS) PRFUNC
      ...
      INTEGER(kind=4) NPTS
      REAL(kind=4) TTHETA,ALP,BET,SIG,GAM,SPH,PFUNC
      REAL(kind=4) DTT(0:NPTS-1),PRFUNC(0:NPTS-1),DPRDT,ALPART,BEPART,SIGPART
...
Cf2py depend(NPTS) SLPART
      ...
      INTEGER(kind=4) NPTS
      REAL(kind=4) TTHETA,ALP,BET,SIG,GAM,SHL,HPART,SGPART,GAPART,PFUNC
      REAL(kind=4) DTT(0:NPTS-1),DPRDT(0:NPTS-1),ALPART(0:NPTS-1),
...
Cf2py depend(NPTS) PRFUNC
      ...
      INTEGER(kind=4) NPTS
      REAL(kind=4) ALP,BET,SIG,GAM,SHL
      REAL(kind=4) DTT(0:NPTS-1),PRFUNC(0:NPTS-1),DPRDT,ALPPART,
...
Cf2py depend(NPTS) GAMPART
      ...
      INTEGER(kind=4) NPTS
      REAL(kind=4) ALP,BET,SIG,GAM,SHL
      REAL(kind=4) DTT(0:NPTS-1),DPRDT(0:NPTS-1),ALPPART(0:NPTS-1),
...
Cf2py depends(N) WT
      ...
      INTEGER(kind=4) N
      REAL(kind=4) X1,X2,GL(0:N-1),WT(0:N-1)
