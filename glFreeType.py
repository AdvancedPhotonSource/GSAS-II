...
class font_data:
	def __init__ (self, facename, pixel_height):
		...
		try:
           ...
           #ft = ImageFont.load ("D:\python27-64\Lib\site-packages\PIL\Images\courB08.pil")
		except:
			raise ValueError, "Unable to locate font '%s'" % (facename)
...
if __name__ == "__main__":
	print "testing availability of freetype font courier\n"
	ft = ImageFont.load ("D:\python27-64\Lib\site-packages\PIL\Images\courB08.pil")
	if ft:
		print "Found the font"
	else:
