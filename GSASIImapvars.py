...
:func:`StoreEquivalence`
  ...
  The latter will run more efficiently. Note that mixing independent and dependent variables would
  require assignments to be done in a particular order and thus is not is not allowed. This will cause an
  error:
...
problemVars = [] # variables causing errors
dependentVars = []
independentVars = []
