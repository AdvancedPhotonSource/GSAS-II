...
class TextElement:
    ...
    def __init__(self, text="", font=None, foreground=wx.WHITE, centered=False):
        """
        text (String)         - Text
...
class Text:
    ...
    def _initText(self):
        ...
        for element in self._texts:
            if (
                ...
                and element.font == self._font
                and element.foreground == self._foreground
                and element.centered == self._centered
            ):
        ...
        if not self._aloc_text:
            ...
            aloc_text = self._aloc_text = TextElement(
                self._text, self._font, self._foreground, self._centered
            )
            aloc_text.bind()
    ...
    foreground = property(
        getForeground, setForeground, None, "Color/Overlay bitmap of the text"
    )
    ...
    text_element = property(
        getTextElement, None, None, "TextElement bound to this class"
    )
