...
# atom Sizees, bond radii, angle radii, H-bond radii
AtmSize = {
    'H': [0.98,  0.78, 1.20, 0],
    'D': [0.98,  0.78, 1.20, 0],
    'T': [0.98,  0.78, 1.20, 0],
...
# atom masses & neutron scattering length (b,b'), sig(incoh) @ 1A
    ...
    'Rh_':   {'Mass':102.906,'BW-LS':[   0.59,      78.92, 6155.6, 1257., 78.0,0,0,0,0]},     #BW
    'Rh_103':{'Mass':102.906,'BW-LS':[   0.59,      78.92, 6155.6, 1257., 78.0,0,0,0,0]},     #BW
    'Pd_':   {'Mass':  106.4,'SL':[   .591,      0],'SA':         6.9},
    'Ag_':   {'Mass':107.868,'SL':[  .5922,      0],'SA':        63.3},
    'Cd_':   {'Mass': 112.41,'BW-LS':[    .483,      -.070, 2520.,0,0,0,0,0,0]},
    'Cd_112':{'Mass':111.903,'SL':[   .634,      0],'SA':         2.2},
    'Cd_113':{'Mass':112.904,'BW-LS':[  0.625,      267.0, 15218., 177.6, 57.0,0,0,0,0]},     #BW
    'Cd_114':{'Mass':113.903,'SL':[   .748,      0],'SA':         .34},
    'Cd_116':{'Mass':115.905,'SL':[   .626,      0],'SA':        .075},
    'In_':   {'Mass': 114.82,'BW-LS':[  .4065,     -.0539,  194.,0,0,0,0,0,0]},
    'In_113':{'Mass':112.904,'SL':[   .539,      0],'SA':         12.},
    'In_115':{'Mass':114.904,'BW-LS':[  0.400,      0.354, 10.793, 97.30, 30.5,0,0,0,0]},     #BW
    ...
    'Sm_':   {'Mass':  150.4,'BW-LS':[  0.418,      29.72, 1009.4, 97.23, 32.91,0,0,0,0]},     #LS
    'Sm_149':{'Mass':148.917,'BW-LS':[  0.525,      213.7, 7256.4, 97.23, 32.90,0,0,0,0]},     #LS
    'Sm_152':{'Mass':151.920,'SL':[   -.50,      0],'SA':        206.},
    'Sm_154':{'Mass':153.922,'SL':[    .80,      0],'SA':         8.4},
    'Eu_':   {'Mass': 151.96,'BW-LS':[  0.748,      61.91, 2742.6, 460.2, 43.74, .1350, 321.1, 0.229, -36.4]},  #LS
    'Eu_151':{'Mass':150.920,'BW-LS':[  0.704,      129.4, 5658.4, 460.2, 43.64, .1342, 321.2, 0.191, -28.9]},  #LS
    'Eu_153':{'Mass':152.921,'SL':[   .822,      0],'SA':        312.},
    'Gd_':   {'Mass': 157.25,'BW-LS':[  0.685,      72.74, 3967.4, 30.58, 53.13,0,0,0,0]},     #LS
    'Gd_155':{'Mass':154.923,'BW-LS':[  0.683,      88.78, 4684.9, 28.11, 52.61,0,0,0,0]},     #LS
    ...
    'Er_':   {'Mass': 167.26,'BW-LS':[  0.853,      11.97,  533.9, 460.0, 44.17, .6448, 584.3,0,0]}, #LS
    'Er_167':{'Mass':166.932,'BW-LS':[  0.564,      52.22, 2298.0, 460.0, 44.02, .6451, 584.2,0,0]}, #LS
    'Tm_':   {'Mass':168.934,'SL':[   .707,      0],'SA':        100.},
    'Tm_169':{'Mass':168.934,'SL':[   .707,      0],'SA':        100.},
    'Yb_':   {'Mass': 173.04,'BW-LS':[  1.229,      0.560,  34.28, 597.1, 33.08,0,0,0,0]},    #LS
    'Yb_168':{'Mass':167.934,'BW-LS':[  0.699,      636.9, 21095., 597.1, 33.08,0,0,0,0]},    #LS
    'Lu_':   {'Mass':174.967,'SL':[   .721,      0],'SA':        74.0},
    'Lu_176':{'Mass':175.943,'BW-LS':[  0.818,      26.17,  850.3, 141.3, 31.51,0,0,0,0]},    #LS
    ...
    'Pu_239':{'Mass':239.052,'BW-LS':[  0.896,      22.68, 1157.0, 296.0, 51.00,0,0,0,0]},   #BW
    'Pu_240':{'Mass':240.054,'BW-LS':[  0.874,      516.0, 8591.3, 1056., 16.65,0,0,0,0]},   #BW
...
#neutron magnetic form factor coeff: M for j<0> & N for j<2>
    ...
    'Yb+2':{'M':[     .0855, 18.512,  .2943,  7.373,   .6412,  2.678,  .0000,   .000, -.0213],
