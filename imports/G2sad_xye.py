...
# $Date: 2014-01-16 15:55:36 -0600 (Thu, 16 Jan 2014) $
# $Author: vondreele $
# $Revision: 1199 $
# $URL: https://subversion.xor.aps.anl.gov/pyGSAS/trunk/imports/G2pwd_xye.py $
# $Id: G2pwd_xye.py 1199 2014-01-16 21:55:36Z vondreele $
########### SVN repository information ###################
'''
...
import GSASIIpath
GSASIIpath.SetVersionNumber("$Revision: 1199 $")
...
class qxye_ReaderClass(G2IO.ImportSmallAngleData):
