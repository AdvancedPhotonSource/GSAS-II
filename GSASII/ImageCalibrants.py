...
Calibrants = {
    ...
    "LaB6  SRM660b": (
        ...
        [""],
        [
            (4.15689, 4.15689, 4.15689, 90, 90, 90),
        ],
        0,
        (1.0, 10, 10.0),
    ),
    "LaB6  SRM660a": (
        ...
        [""],
        [
            (4.1569162, 4.1569162, 4.1569162, 90, 90, 90),
        ],
        0,
        (1.0, 10, 10.0),
    ),
    ...
    "LaB6  SRM660": (
        ...
        [""],
        [
            (4.15695, 4.15695, 4.15695, 90, 90, 90),
        ],
        0,
        (1.0, 10, 10.0),
    ),
    "Si    SRM640c": (
        ...
        ["F d 3 m"],
        [
            (5.4311946, 5.4311946, 5.4311946, 90, 90, 90),
        ],
        0,
        (1.0, 10, 10.0),
        (3, 10, 13, 20, 23, 26, 33, 35, 40, 43),
    ),
    "CeO2  SRM674b": (
        [
            0,
        ...
        [""],
        [
            (5.411651, 5.411651, 5.411651, 90, 90, 90),
        ],
        0,
        (1.0, 2, 1.0),
    ),
    "Al2O3 SRM676a": (
        ...
        ["R -3 c"],
        [
            (4.759091, 4.759091, 12.991779, 90, 90, 120),
        ],
        0,
        (1.0, 5, 5.0),
    ),
    "Ni   @ 298K": (
        ...
        [""],
        [
            (3.52475, 3.52475, 3.52475, 90, 90, 90),
        ],
        0,
        (1.0, 10, 10.0),
    ),
    ...
    "Ag behenate": (
        ...
        [""],
        [
            (1.0, 1.0, 58.380, 90, 90, 90),
        ],
        0,
        (7.0, 5, 1.0),
    ),
    "Spun Si 3600 line/mm grating": (
        [
            6,
        ],
        [""],
        [
            (1.0, 1.0, 2777.78, 90, 90, 90),
        ],
        2,
        (200.0, 5, 1.0),
    ),
    "Spun Si 7200 line/mm grating": (
        [
            6,
        ],
        [""],
        [
            (1.0, 1.0, 1388.89, 90, 90, 90),
        ],
        1,
        (200.0, 5, 1.0),
    ),
