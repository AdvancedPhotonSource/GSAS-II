...
ElTable = [
    ...
    (["D","D-1"],                  0,0, "Deuterium",   White,           0.0000,(255,255,255)),
    (["T","T-1"],                  0,0, "Tritium",     White,           0.0000,(255,255,255)),
    ...
    (["B",],                       2,1, "Boron",       NonMetcolor,     0.0012,(255,181,181)),
    ...
    (["Al","Al+3"],                2,2, "Aluminum",    SemMetcolor,     0.0125,(191,166,166)),
